function [] = preproc_CRU(chosen_prd)
    ...
    for v=1:size(vars_in,2)
        ...
        dir_in=sprintf('%s/CRU/CRU-TS405/mon/orig/%s',data_src, vars_in{v});
        ...
        for y=yr_s:yr_e
            ...
            for decade_id=1:ndecade
                ...
                fname=sprintf('cru_ts4.05.%d.%d.%s.dat.nc',data_decade_sy,data_decade_ey,vars_in{v});
