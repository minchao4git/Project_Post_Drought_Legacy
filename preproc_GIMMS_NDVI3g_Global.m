function [] = preproc_GIMMS_NDVI3g_Global(pp_type)
    ...
    if strcmp(pp_type,'RS_05')
        ...
        for m=1:12
            DATA_VI_05rs_out(:,:,m,1:nyr,ds_id)=squeeze(nanmean(DATA_VI_05rs_bw_out(:,:,(m*2-1):m*2,1:nyr,ds_id),3));
            DATA_VI_05rs_sm_out(:,:,m,1:nyr,ds_id,1:nmd)=squeeze(nanmean(DATA_VI_05rs_bw_sm_out(:,:,(m*2-1):m*2,1:nyr,ds_id,1:nmd),3));
        end
